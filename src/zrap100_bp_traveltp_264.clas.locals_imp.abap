CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS:
      ...
      set_status_to_open FOR DETERMINE ON MODIFY
        IMPORTING
          keys FOR Travel~setStatusToOpen,
      ...
      reject_travel FOR MODIFY
        IMPORTING keys
                    FOR ACTION travel~rejectTravel
        RESULT    result,
      deduct_discount FOR MODIFY
        IMPORTING keys
                    FOR ACTION travel~deductDiscount
        RESULT    result,
      copy_travel FOR MODIFY
        IMPORTING keys
                    FOR ACTION travel~copyTravel,
...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA:
      entity        TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_264,
...
*  data: travel_read type TABLE for READ IMPORT ZRAP100_R_TravelTP_264\\Travel.
    ...
    READ ENTITIES OF ZRAP100_R_TravelTP_264 IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_264 IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
  METHOD deduct_Discount.
    DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_264.
...
**************************************************************************
  METHOD copy_Travel.
    ...
    DATA:
      travels       TYPE TABLE FOR CREATE zrap100_r_traveltp_264\\travel.
